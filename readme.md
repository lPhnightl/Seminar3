...
## Скачивание с удалённого репозитория 
 ...
 Отправить изменения в удалённый репозиторий можно с помощью команды *git push*. Для этого применте в папке с репозиторием команды *git push origin <название ветки>* для отправки изменений в указаную ветку. По умолчанию
